...
# Load models
heart_model = load_model("notebooks/heart_model.pkl")
diabetes_model = load_model("notebooks/diabetes_model.pkl")
...
choice = st.sidebar.selectbox("Choose Disease...", menu)
...
if choice == "Heart Disease":                           
    ...
    thalach = st.number_input("Max Heart Rate Achieved", 70, 200, 150)
